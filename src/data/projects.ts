export const projects = [
  {
    id: 'centre-sante-bien-etre-mentale',
    title: 'Centre de santé et du bien-être mental',
    category: 'Paramédical & Social',
    location: 'Pantin, France',
    year: '2025',
    image: '/portfolio/projects/affichage/Sante.png',
  ...
  {
    id: 'les-maisons-de-el-bario',
    title: 'Les maisons de "El Bario"',
  ...
  {
    id: "l'aquila-shigeru-ban",
    title: "L'Aquila Shigeru Ban",
  ...
  {
    id: "la-maison-des-avocats",
    title: "La Maison des Avocats",
